        ...
        const fetchData = async () => {
            ...
            try {
                ...
                setMentorData({
                    ...mentorResponse.data,
                    profile: {
                        name: user.name || mentorResponse.data.name || 'N/A', // Fallback to 'N/A' if name is missing
                        email: user.email || mentorResponse.data.email || 'N/A', // Fallback to 'N/A' if email is missing
                        skills: mentorResponse.data.skills || [], // Fallback to an empty array if skills are missing
                    },
                    students: mentorResponse.data.students || [], // Fallback to an empty array
                    teams: mentorResponse.data.teams || [], // Fallback to an empty array
                    submissions: mentorResponse.data.submissions || [], // Fallback to an empty array
                    announcements: mentorResponse.data.announcements || [], // Fallback to an empty array
                });
